...
const algosdk2_2_1 = require("algosdk2-2");
/**
...
class ApplicationClient {
    ...
    constructor(appDetails, algod) {
        ...
        if (appIdentifier.resolveBy === 'id') {
            ...
            if (appIdentifier.findExistingUsing instanceof algosdk_1.Indexer) {
    ...
    async compile(compilation) {
        ...
        const approval = (0, app_deploy_1.replaceDeployTimeControlParams)((0, app_deploy_1.performTemplateSubstitution)(approvalTemplate, deployTimeParams ?? this.deployTimeParams), {
            updatable,
            deletable,
        });
        ...
        const clear = (0, app_deploy_1.performTemplateSubstitution)(clearTemplate, deployTimeParams ?? this.deployTimeParams);
    ...
    async call(call) {
        ...
        call?.method &&
            ...
            // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
            this.appSpec.hints[(0, app_1.getABIMethodSignature)(this.getABIMethod(call.method))].read_only) {
    ...
    async callSimulateOnAtc(atc, algod) {
        try {
            ...
            if (e instanceof Error && e.message.startsWith('Network request error. Received status 400 (Bad Request): msgpack decode')) {
                ...
                algod2_2.simulateRawTransactions = algosdk2_2_1.Algodv2.prototype.simulateRawTransactions;
                const atc2_2 = Object.create(atc);
                atc2_2.simulate = algosdk2_2_1.AtomicTransactionComposer.prototype.simulate;
    ...
    async getCallArgs(args, sender) {
        ...
        if (args.method) {
            ...
            const methodSignature = (0, app_1.getABIMethodSignature)(abiMethod);
            return {
                ...args,
                method: abiMethod,
                    ...
                    switch (defaultValueStrategy.source) {
                        ...
                        case 'abi-method': {
                            ...
                            const result = await this.callOfType({
                                method: (0, app_1.getABIMethodSignature)(method),
